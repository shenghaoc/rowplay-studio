...
struct Replay2DVenuePalette {
    ...
    init(_ hex: [String]) {
        ...
        skyTop = Color.requiredReplay2DHex(hex[0])
        skyHorizon = Color.requiredReplay2DHex(hex[1])
        haze = Color.requiredReplay2DHex(hex[2])
        sun = Color.requiredReplay2DHex(hex[3])
        ridgeFar = Color.requiredReplay2DHex(hex[4])
        ridgeNear = Color.requiredReplay2DHex(hex[5])
        foliageFar = Color.requiredReplay2DHex(hex[6])
        foliageNear = Color.requiredReplay2DHex(hex[7])
        structure = Color.requiredReplay2DHex(hex[8])
        structureShade = Color.requiredReplay2DHex(hex[9])
        structureLight = Color.requiredReplay2DHex(hex[10])
        groundTop = Color.requiredReplay2DHex(hex[11])
        groundMid = Color.requiredReplay2DHex(hex[12])
        groundBottom = Color.requiredReplay2DHex(hex[13])
        surfaceLine = Color.requiredReplay2DHex(hex[14])
        surfaceHighlight = Color.requiredReplay2DHex(hex[15])
        surfaceShadow = Color.requiredReplay2DHex(hex[16])
        marker = Color.requiredReplay2DHex(hex[17])
        safety = Color.requiredReplay2DHex(hex[18])
        safetyLight = Color.requiredReplay2DHex(hex[19])
    }
}

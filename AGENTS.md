...
This file (`AGENTS.md`) is the canonical shared guide for all coding agents. Agent-specific entrypoints defer to this file:

- `CLAUDE.md` — Claude Code entrypoint
- `.github/copilot-instructions.md` — GitHub Copilot / coding agent entrypoint
- `GEMINI.md` — Gemini CLI / Antigravity entrypoint

The repo also has autogenerated `.codex/environments/environment.toml`, local `.claude/settings.local.json`, and lowercase `.jules/*` notes. If any agent file conflicts with `AGENTS.md`, this file wins.

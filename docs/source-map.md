...
| `src/lib/replay/raceCard.ts` | `Sources/RowPlayCore/Replay/ReplayRaceReport.swift` + `Sources/RowPlayStudio/Views/ReplayRaceCardView.swift` | Phase 10B local privacy-safe race report JSON and native race-card PNG (ImageRenderer); no public URL. |

...
| `src/lib/replay/sources.ts` | `Sources/RowPlayCore/Replay/ReplayRivalFactory.swift` + `ReplayRivalFileParser.swift` | Phase 10B ports constant-pace ghost creation and CSV/TCX/FIT rival import without browser File/DOM APIs. |
